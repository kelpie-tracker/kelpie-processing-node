...
import br.pucrio.inf.lac.mapa.GeographicMap;
import br.pucrio.inf.lac.model.Inspector;
import br.pucrio.inf.lac.model.Region;
import br.pucrio.inf.lac.model.SamplePredicate;
 ...
 *
 */
public class MainPNGeo implements GroupSelection {
    /** Logger */
    ...
    public MainPNGeo() {
		...
		String fullFilename = workDir + "/geolocations/RioDeJaneiro.txt";
